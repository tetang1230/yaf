 ...
 * CURL HTTP工具类
 * @modify: Jerry Yang(hy0kle@gmail.com)
 *
 * 支持以下功能:
 * 1:支持ssl连接和proxy代理连接
 * 2: 对cookie的自动支持
...
class CurlTools
{
    ...
    public function __construct($setopt = array())
    {
        ...
        //// 设置 HTTP USERAGENT
        //$user_agent = $this->setopt['user_agent']
        //    ? $this->setopt['user_agent']
        //    : (isset($_SERVER['HTTP_USER_AGENT']) && $_SERVER['HTTP_USER_AGENT']
        //        ? $_SERVER['HTTP_USER_AGENT']
        //        : '');
        //$user_agent && curl_setopt($this->ch, CURLOPT_USERAGENT, $user_agent);
